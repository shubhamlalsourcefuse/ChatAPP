...
import {LocalSignupTokenProvider} from './providers/local-signup-token.provider';
...
export class AuthenticationApplication extends BootMixin(
  ...
  constructor(options: ApplicationConfig = {}) {
    ...
    this.bind(SignUpBindings.SIGNUP_HANDLER_PROVIDER).toProvider(LocalSignupTokenProvider)
